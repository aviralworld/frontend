...
<section>
  ...
  <label for="user-occupation" class="label"
  ...
  <label class="label" for="user-location"
    >Where do you live?
    <input
      type="text"
      name="location"
  ...
  <label class="label" for="user-email"
    ...
    <span class="addendum"
      >(If you share this, we will <strong>only</strong> use it to email you the
      link to manage your recording, as a reminder, and major updates about the
      project. You can also choose not to share it, in which case you’ll still
      be able to copy the link and save it once you’ve published your
      recording.)</span
    ></label
  >
</section>
