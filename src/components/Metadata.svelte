...
<p>What is your story about? <Dropdown options={categories} id="user-category" name="category" optional={false} bind:selection={category_id} /></p>
...
<section>
  ...
  <p>What is your age? <Dropdown options={ages} id="user-age" name="age" optional={true} bind:selection={age_id} /></p>

  <p>What gender do you identify as? <Dropdown options={genders} id="user-gender" name="gender" optional={true} bind:selection={gender_id} /></p>
